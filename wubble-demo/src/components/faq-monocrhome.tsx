...
const faqs = [
  {
    id: "1",
    question: "How does the conversational AI sound engineer work?",
    answer:
  ...
  {
    id: "2",
    question: "Is the generated music and SFX copyright-free for commercial use?",
    answer:
  ...
  {
    id: "4",
    question: "How realistic is the voice cloning and is it secure?",
    answer:
      "All components follow WAI-ARIA standards, featuring proper ARIA attributes, keyboard navigation, and screen reader support. Regular testing ensures compatibility with NVDA, VoiceOver, and JAWS.",
    meta: "Security & Realism",
  },
  {
    id: "5",
    question: "Can I upload my own audio files for Wubble to mix, edit, and clean?",
    answer:
      "All components follow WAI-ARIA standards, featuring proper ARIA attributes, keyboard navigation, and screen reader support. Regular testing ensures compatibility with NVDA, VoiceOver, and JAWS.",
    meta: "Functionality",
  },
  {
    id: "6",
    question: "What do you mean by 'DAW-level' engineering?",
    answer:
      "All components follow WAI-ARIA standards, featuring proper ARIA attributes, keyboard navigation, and screen reader support. Regular testing ensures compatibility with NVDA, VoiceOver, and JAWS.",
    meta: "Features",
  },
  {
    id: "7",
    question: "How does Wubble integrate with my existing workflow (e.g., Unity, Premiere Pro)?",
    answer:
      "All components follow WAI-ARIA standards, featuring proper ARIA attributes, keyboard navigation, and screen reader support. Regular testing ensures compatibility with NVDA, VoiceOver, and JAWS.",
    meta: "Integration",
  },
  {
    id: "8",
    question: "What's the difference between the Free, Pro, and Teams plans?",
    answer:
      "All components follow WAI-ARIA standards, featuring proper ARIA attributes, keyboard navigation, and screen reader support. Regular testing ensures compatibility with NVDA, VoiceOver, and JAWS.",
    meta: "Plans",
  },
  {
    id: "9",
    question: "How does the Wubble API work?",
    answer:
      "All components follow WAI-ARIA standards, featuring proper ARIA attributes, keyboard navigation, and screen reader support. Regular testing ensures compatibility with NVDA, VoiceOver, and JAWS.",
    meta: "API",
  },
...
function FAQ1() {
  ...
  return (
    <div className={`relative min-h-screen w-full overflow-hidden transition-colors duration-700 ${palette.surface}`}>
      ...
      <div
        className="pointer-events-none absolute inset-0 z-0 opacity-80 w-full"
        style={{ background: palette.overlay, mixBlendMode: theme === "dark" ? "screen" : "multiply" }}
      />

      <section
        className={`relative z-10 mx-auto flex flex-col gap-12 px-6 py-24  lg:px-12 ${
