    ...
    <section className="py-20 w-full">
      ...
      <div className="pt-10  md:pt-16 lg:pt-20">
        <div className="relative w-full flex items-center justify-center overflow-hidden ">
          ...
          <div className="absolute inset-y-0 left-0 w-12 bg-linear-to-r from-gray-700/50 to-transparent"></div>
          <div className="absolute inset-y-0 right-0 w-12 bg-linear-to-l from-gray-700/50 to-transparent"></div>
        </div>
      </div>
    </section>
  );
