    ...
    <div className="aspect-[24/24] grow min-h-px min-w-px overflow-clip relative shrink-0">
      <div className="absolute aspect-[24/16] left-0 right-0 top-1/2 -translate-y-1/2">
        <svg className="block size-full" fill="none" viewBox="0 0 24 16">
          <g>
            <path d={svgPaths.p36880f80} fill="black" />
            <path d={svgPaths.p355df480} fill="black" />
            <path d={svgPaths.pfa0d600} fill="black" />
          </g>
        </svg>
      </div>
    </div>
    ...
    <div className="relative shrink-0 w-full">
      <div className="flex items-center p-1 w-full">
        ...
        <div className="px-2 py-1">
          <div className="font-['Lexend:SemiBold',_sans-serif] text-[16px] text-muted-foreground">
            Interfaces
          </div>
        </div>
      </div>
...
function AvatarCircle() {
  return (
    <div className="relative rounded-full shrink-0 size-8 bg-background">
      ...
      sections: [
        {
          ...
          items: [
            ...
            { icon: <Filter size={16} className="text-foreground" />, label: "Filter projects" },
          ],
        },
        {
      ...
      {!isCollapsed && (
        <div className="w-full  pt-2 border-t border-primary/50  mt-20">
          <div className="flex items-center gap-2 px-2 py-2">
            ...
            <button
              type="button"
              className="ml-auto size-8 rounded-md flex items-center justify-center hover:bg-primary"
              aria-label="More"
            >
...
function SubMenuItem({ item, onItemClick }: { item: MenuItemT; onItemClick?: () => void }) {
  return (
    <div className="w-full pl-9 pr-1 py-[1px]">
      <div
        className="h-10 w-full rounded-lg cursor-pointer transition-colors hover:bg-primary/50 flex items-center px-3 py-1"
        onClick={onItemClick}
      >
...
export function SideBar() {
  return (
    <div className="fixed flex items-center justify-center z-50 h-[90vh] mt-[4rem] py-[10rem] ">
      <TwoLevelSidebar />
    </div>
  );
}
