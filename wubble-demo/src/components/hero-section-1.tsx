...
const Industries = [
    { name: 'Hospitality', color: '#b3ffc4' },
    { name: "Gaming", color: '#b7b3ff' },
    { name: "Content Creator", color: '#ffddb3' },
    { name: "Marketer", color: '#2596be' }
...
export function HeroSection() {
    return (
        <>
            ...
            <main className="overflow-hidden border w-full ">
                <div
                    aria-hidden
                         ...
                         */}
                                ...
                                <AnimatedGroup
                                    ...
                                    <div
                                        ...
                                        <p>Please choose your industry to help Wubble work better -</p>
                                        <div className='flex gap-10'>
                                            {Industries.map((industry, index) => (
                                                <Button variant={'outline'} key={index} className={`border-4 `} style={{ borderColor: industry.color }} >{industry.name}</Button>
                                            ))}
                                        </div>
