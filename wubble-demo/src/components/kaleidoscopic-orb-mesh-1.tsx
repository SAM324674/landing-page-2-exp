...
const fragmentShaderSource = `
    ...
    void main() {
      ...
      // --- Gradient between #6a5ae7 and #d622ef ---
vec3 color1 = vec3(0.415, 0.353, 0.905); // #6a5ae7 (purple)
vec3 color2 = vec3(0.839, 0.133, 0.937); // #d622ef (magenta)

// Create a smooth gradient across the orb
float gradient = smoothstep(-0.3, 0.8, d + 0.3);
vec3 objColor = mix(color1, color2, gradient);

// Add a bit of time-based shimmer to make the gradient “move”
objColor += 0.1 * sin(iTime * 0.8 + d * 5.0);
