...
const SelectorChips: React.FC<SelectorChipsProps> = ({ options, onChange }) => {
  ...
  return (
    <div className="flex flex-wrap gap-2 max-w-xl w-full bg-background p-4  rounded-3xl ">
      {options.map((option) => {
        ...
        return (
          <motion.button
            ...
            className="flex items-center justify-center px-3 py-1 rounded-full text-xs font-medium border transition overflow-hidden grow cursor-pointer"
            style={{ minWidth: 100 }}
          >
