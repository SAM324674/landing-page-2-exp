    ...
    <Dialog.Root open={open} onOpenChange={handleOpenChange}>
      <Dialog.Trigger asChild>
        <Button
          ref={triggerRef}
          type="button"
          className="inline-flex items-center justify-center rounded-md  px-4 py-2 text-sm font-medium text-white focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2"
        >
          {trigger}
        </Button>
      </Dialog.Trigger>
        ...
        {open && triggerRect && (
          <Dialog.Portal forceMount>
            ...
            <Dialog.Content asChild>
              ...
              >
                <motion.div
                  className={cn("bg-white rounded-lg shadow-xl w-full mx-auto p-6 ",className)}
                  initial={{
                    opacity: 0,
