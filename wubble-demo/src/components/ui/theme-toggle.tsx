...
export function ThemeToggle() {
  ...
  return (
    <div className="bg-tertiary relative flex w-full scroll-m-4 flex-col ">
      <div className="flex flex-wrap items-center justify-between gap-3 px-3 pt-3 w-full ">
        <div className="w-full text-base text-primary font-bold">Theme</div>
      </div>
      <p className="text-sm text-gray-500 font-bold mt-0.5 px-3 lg:max-w-full">
        Choose how you’d like Wubble to appear. Select a theme, or sync themes with your system preferences.
      </p>
      ...
      <div className="p-8 pt-4">
        <form>
          <RadioGroup
            ...
            className="flex gap-10 max-sm:space-y-3 sm:grid-cols-3"
          >
            {themes.map((themeOption) => {
              ...
              return (
                <div
                  ...
                  className={cn(
                    "flex items-end justify-center rounded-md border px-1.5 pt-3 transition w-[15rem]",
                    currentSystemTheme,
                    {
